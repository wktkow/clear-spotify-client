...
def generate_web_bridge_css(colors: dict[str, str]) -> str:
    ...
    return "\n".join([
        ...
        "  height: 100% !important;",
        "}",
        "/* Play button overlay in library — constrain to image size */",
        '#Desktop_LeftSidebar_Id [data-encore-id="listRow"] div:has(> [data-testid="entity-image"]) > div:not(:has([data-testid="entity-image"])) {',
        "  position: absolute !important;",
        "  inset: 0 !important;",
        "}",
        "",
